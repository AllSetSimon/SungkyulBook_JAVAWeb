...
<body>
	...
	<section class="container">
		<form method="get" action="./engineerContent.jsp" class="form-inline mt-3">
		...
		bookList = new BookDAO().getEngineerList(searchType, search, pageNumber);
		if(bookList != null)
	...
	<a class="page-link" href="./engineerContent.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide,"UTF-8")%>&searchType=
