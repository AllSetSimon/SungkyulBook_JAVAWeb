...
<body>
	...
	<section class="container">
		...
		bookList = new BookDAO().getMyLikeList(userID);
		if(bookList != null)
	...
	<div class="card bg-light mt-3">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				%>
					<a onclick="return confirm('찜리스트에서 삭제하실겁니까?')" href="./deleteLikeAction.jsp?sellBookID=<%=book.getSellBookID() %>">찜리스트에서 삭제</a>
				</div>
			</div>
		</div>
	</div>
	...
	<a class="page-link" href="./myLikeList.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide,"UTF-8")%>&searchType=
