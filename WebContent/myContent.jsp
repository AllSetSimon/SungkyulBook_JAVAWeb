...
<body>
	...
	<section class="container">
		...
		bookList = new BookDAO().getMyList(userID);
		if(bookList != null)
	...
	<div class="card bg-light mt-3">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				%>			
					<a class="btn btn-danger mx-1 mt-2" href="./purchaseCancelAction.jsp?sellBookID=<%=book.getSellBookID() %>">거래 철회</a>
				<%
				}
				%>
					<a onclick="return confirm('구매마감 및 삭제하시겠습니까?')" href="./deleteAction.jsp?sellBookID=<%=book.getSellBookID() %>">구매마감 및 삭제</a>
				</div>
			</div>
		</div>
	</div>
	...
	<a class="page-link" href="./myContent.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide,"UTF-8")%>&searchType=
