...
<body>
	...
	<section class="container">
		<form method="get" action="./godContent.jsp" class="form-inline mt-3">
		...
		bookList = new BookDAO().getGodList(searchType, search, pageNumber);
		if(bookList != null)
	...
	<a class="page-link" href="./godContent.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide,"UTF-8")%>&searchType=
