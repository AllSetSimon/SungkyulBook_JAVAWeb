...
<body>
	...
	<section class="container">
		<form method="get" action="./artContent.jsp" class="form-inline mt-3">
		...
		bookList = new BookDAO().getArtList(searchType, search, pageNumber);
		if(bookList != null)
	...
	<a class="page-link" href="./artContent.jsp?lectureDivide=<%= URLEncoder.encode(lectureDivide,"UTF-8")%>&searchType=
